...
<head>
	...
	<meta property="og:description" content="选手姓名：[!--hai_name--];上传时间：<?=$name?>;赛区：[!--hai_division--];分组：[!--hai_grouping--];目前票数：<?php
                        $id=$_GET['id'];
...
<!-- 手机端新版投票注册界面结束 -->
<div class="toupiao-pop-down"></div>
<!-- ······························头部结构····································· -->
	[!--temp.tou--]
<!-- 头部结构结束·························································· -->
...
<div class="bodyWrap clearfix">
	...
	<div class="rightWrap clearfix">
		...
		<!-- 报名框结束 -->
		<div class="rightBan">
			<div class="mianbaoNav gg" style="overflow:hidden;">
				<span><a href="[!--news.url--]">首页</a></span><span>></span><span><a href="[!--news.url--]haixuan">海选</a></span><span>></span><span><a href="javascript:;">赛事详情</a></span>			</div>
...
-->					<li><span>赛区：</span><span>[!--hai_division--]</span></li>
					...
					<li><span>目前票数：</span><span class="hongse currentPiaoNum">
                    	<?php
                        $id=$_GET['id'];
$tou=$empire->fetch1("select tou_num from phome_ecms_photo where id='$id'");
        echo $tou[tou_num];
                        ?>
                    票</span></li>
					<h2 class="userpic" style="display: none">
						<img class="userpic" src="[!--hai_photo--]" alt="">
					</h2>
                    <div class="audition-member-share">
						...
						<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"[!--hai_petition--]","bdMini":"2","bdMiniList":false,"bdPic":"[!--hai_photo--]","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
					</div>
					<script type="text/javascript">
						$(function() {
							var Url = window.location.pathname;
								Url = "https://www.facebook.com/sharer/sharer.php?u=http://www.greattone.net"+Url;
			...
			<script>
		        ...
		        appkey:'4yh_rdnre',
		        //video:'http://play.videojj.com.fastcdn.com/20151023/videojj_mov/videojj_720p.mp4',
		        video:'[!--hai_video--]',
		        skinSelect: 2,
		        autoplay:true,
		        right_hand:false,
			  ...
			  <!--投票提示框开始·············································-->
				...
				<div class="toupiao-pop toupiao-web">
					...
					<div class="ad-img" id="ad-img-web">
						<!-- 这里面是广告 -->
						<!--<script src="http://www.greattone.net/d/js/acmsd/thea67.js"></script>-->
						<script type="text/javascript">
			...
			<div class="video-ad" style="width: 960px;height: 90px;">
